---
title: "Routes Tab"
summary: "The Routes tab displays all routes in tree or list view, shows active routes, route types, and detailed route info including loaders, actions, error boundaries, and wildcard parameters."
