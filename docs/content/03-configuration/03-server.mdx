...
summary: "Configure React Router Devtools server logging, including options for silence, cookies, deferred data, actions, loaders, cache, site clears, and server timings."
